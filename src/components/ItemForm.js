        ...
        <Modal.Body>
            ...
            <Form className="form-inline" onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3" >
                    ...
                    <Form.Control type="date" placeholder="Expiry date" value={expiry_date} onChange={(e => setExpiryDate(e.target.value))}/>
                </Form.Group>

                <Form.Group className="mb-3" >
                    <Form.Check type="checkbox" label="Opened" checked={checked} onChange={e => setChecked(e.target.checked)}/>
                </Form.Group>
